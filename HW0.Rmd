...
&=\begin{dcases}
    \int_0^1(x+y)dy, \text{for } 0\leq x \leq 1, \text{and } 0\leq y \leq 1\\
    0,               \text{otherwise}
\end{dcases}\\
&= \begin{dcases}
   \left(\frac{1}{2}x^2 +xy \right)\Big|_0^1, \text{for } 0\leq y \leq 1\\
    0,               \text{otherwise}
\end{dcases}\\
&=\begin{dcases}
    \frac{1}{2} + y, \text{for } 0\leq y \leq 1\\
    0,               \text{otherwise}
\end{dcases}\\
\end{aligned}
$$
...
p(y|x) &= \frac{p(x,y)}{p(x)}\\
 &=\begin{dcases}
    \frac{x+y}{\frac{1}{2} + y}, \text{for } 0\leq x \leq 1, \text{and } 0\leq y \leq 1\\
    0,               \text{otherwise}
\end{dcases}
\end{aligned}
$$
